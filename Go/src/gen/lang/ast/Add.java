...
/**
 * @ast node
 * @declaredat /Users/emingigovic/Desktop/Projekt_Kompilatorer/2015-go-type-inference/Go/src/jastadd/Go.ast:28
 * @production Add : {@link Arithmetic};

 */
public class Add extends Arithmetic implements Cloneable {
  /**
   * @aspect Interpreter
   * @declaredat /Users/emingigovic/Desktop/Projekt_Kompilatorer/2015-go-type-inference/Go/src/jastadd/Interpreter.jrag:255
   */
   ...
   */
  public Add(Type p0, Expression p1, Expression p2) {
    setChild(p0, 0);
    setChild(p1, 1);
    setChild(p2, 2);
  }
