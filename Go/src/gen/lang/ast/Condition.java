...
/**
 * @ast node
 * @declaredat /Users/emingigovic/Desktop/Projekt_Kompilatorer/2015-go-type-inference/Go/src/jastadd/Go.ast:8
 * @production Condition : {@link BinaryExpression};

 */
public abstract class Condition extends BinaryExpression implements Cloneable {
  /**
   ...
   */
  public Condition(Type p0, Expression p1, Expression p2) {
    setChild(p0, 0);
    setChild(p1, 1);
    setChild(p2, 2);
  }
   ...
   */
  @Deprecated
  public abstract Condition fullCopy();
  /**
   * Create a deep copy of the AST subtree at this node.
   * The copy is dangling, i.e. has no parent.
   * @return dangling copy of the subtree at this node
   ...
   */
  public abstract Condition treeCopyNoTransform();
  /**
   * Create a deep copy of the AST subtree at this node.
   ...
   */
  public abstract Condition treeCopy();
  /**
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /Users/emingigovic/Desktop/Projekt_Kompilatorer/2015-go-type-inference/Go/src/jastadd/TypeAnalysis.jrag:36
   */
