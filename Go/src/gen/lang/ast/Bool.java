...
/**
 * @ast node
 * @declaredat /Users/emingigovic/Desktop/Projekt_Kompilatorer/2015-go-type-inference/Go/src/jastadd/Go.ast:50
 * @production Bool : {@link Value};

 */
public class Bool extends Value implements Cloneable {
  /**
   * @aspect Interpreter
   * @declaredat /Users/emingigovic/Desktop/Projekt_Kompilatorer/2015-go-type-inference/Go/src/jastadd/Interpreter.jrag:240
   */
   ...
   */
  public Bool(Type p0, beaver.Symbol p1) {
    setChild(p0, 0);
    setValue(p1);
  }
  /**
   ...
   */
  public Bool treeCopyNoTransform() {
    Bool tree = (Bool) copy();
    if (children != null) {
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node) && (tokenString_Value == ((Bool)node).tokenString_Value);    
  }
  /**
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /Users/emingigovic/Desktop/Projekt_Kompilatorer/2015-go-type-inference/Go/src/jastadd/TypeAnalysis.jrag:62
   */
