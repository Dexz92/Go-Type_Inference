...
public class TestConstants extends AbstractParameterizedTest {
	/**
	 * Directory where test files live
	 */
	private static final String TEST_DIR = "testfiles/constants";

	/**
	 * Construct a new JastAdd test
	 * @param filename filename of test input file
	 */
	public TestConstants(String filename) {
